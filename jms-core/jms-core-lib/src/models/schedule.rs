...
pub enum ScheduleBlockType {
    ...
    FieldTests,
    SetupTeardown,
    Qualification { cycle_time: DBDuration },
    Playoff,
}
...
impl ScheduleBlock {
    ...
    pub fn num_qual_matches(
        &self,
        last_generated_qual_match_time: Option<chrono::DateTime<chrono::Local>>,
    ) -> usize {
